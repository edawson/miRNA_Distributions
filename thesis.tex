...
associated with specific cancer types (). %TODO cite examples like pancreatic
Certain cancer types also show specific microRNA signatures (). %TODO
A pan-cancer superfamily have microRNAs has been discussed %TODO
